        ...
        <div id="adhaar-preview" className="adhaar-preview relative bg-gray-100">
            <div className="grid sm:grid-cols-2 gap-2 py-10 justify-items-center    justify-center">
                ...
                <div className="relative">
                    ...
                    <small className="text-xs absolute left-[50%] translate-x-[-50%] bottom-2 font-bold capitalize leading-relaxed text-red-600">{errors && errors.key === 'adhaarBackFile' && errors.message}</small>
                </div>
